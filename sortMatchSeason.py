...
season_data = [
    ...
    ["Preseason 1", 1314072000001, 1322542799999],
    ["2", 1322542800000, 1352696400000],
    ["Preseason 2", 1352696400001, 1359694799999],
    ["3", 1359694800000, 1384146000000],
    ["Preseason 3", 1384146000001, 1389329999999],
    ["4", 1389330000000, 1415682000000],
    ["Preseason 4", 1415682000001, 1421816399999],
    ["5", 1421816400000, 1447218000000],
    ["Preseason 5", 1447218000001, 1453265999999],
    ["6", 1453266000000, 1478581200000],
    ["Preseason 6", 1478581200001, 1481173199999],
    ["7", 1481173200000, 1510030800000],
    ["Preseason 7", 1510030800001, 1516078799999],
    ["8", 1516078800000, 1541998800000],
    ["Preseason 8", 1541998800001, 1548219599999],
    ["9", 1548219600000, 1574139600000],
    ["Preseason 9", 1574139600001, 1578632399999],
    ["10", 1578632400000, 1604984400000],
    ["Preseason Ten", 1604984400001, 1610081999999],
    ["11", 1610082000000, 1636952400000],
    ["Preseason 11", 1636952400001, 1641531599999],
    ["12", 1641531600000, 1668402000000],
    ["Preseason 12", 1668402000001, 1673413199999],
    ["13", 1673413200000, int(time.time() * 1000)]
]

def sort_match_season(unix_timestamp_ms):
    try:
...
# Call Functions
converted_date = unix_milliseconds_to_date(unix_timestamp_ms)
selected_season = sort_match_season(unix_timestamp_ms)

if selected_season:
    print("Selected Season:", selected_season)
else:
    print("Could not determine season for the given timestamp.")
